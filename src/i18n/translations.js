export const translations = {
  nl: {
    ...
    about_text1: 'SB is ontstaan uit een diepe liefde voor het bakken van taarten en gebak. Elke taart die ik maak is een kunstwerk – van het grote ontwerp tot de kleinste finishing touch.',
  ...
  ti: {
    ...
    hero_title_line2: 'ባዕሉ ዝዛረብ',
    hero_title_em: 'ጣዕሚ',
    hero_title_line3: 'ኣለዎ',
    hero_subtitle: 'ንፍሉይ እዋናት ዝኸውን ብኢድ ዝተሰርሐ ምኡዝ ኬክ። ካብ ናይ መርዓ ኬክ ክሳብ ዘመናዊ ናይ ልደት ኬክ — ነፍሲ ወከፍ ስራሕና ፍሉይ እዩ።',
    hero_btn_order: 'ይኣዝዙ',
    hero_btn_gallery: 'ስራሓትና ርአ →',
    hero_badge_customers: 'ሕጉሳት ዓማዊል',

    // STATS
    stat_customers: 'ሕጉሳት ዓማዊል',
    stat_handmade: 'ብኢድ ዝተዳለወ',
    ...
    filter_special: 'ፍሉያት',
    btn_order_cake: 'እዚ ኬክ እዚ እዘዝ',
    tag_wedding: 'መርዓ',
    tag_birthday: 'ልደት',
    tag_special: 'ፍሉይ',

    // ORDER
    order_title_pre: 'ናይ ሕልሚ ኬካትኩም ',
    order_title_em: 'ኣዝዙ',
    order_intro: 'ነዚ ቅጥዒ እዚ ምልእዎ፤ ኩሉ ዝርዝር ነገራት ንምምይያጥ ድማ ኣብ ውሽጢ 24 ሰዓታት ክንረኽበኩም ኢና።',
    step1: 'ድሌትኩም ዕለት ብምጥቃስ ቅጥዒ ምልኡ',
    step2: 'ውልቃዊ ናይ ዋጋ መግለጺ ክንሰደልኩም ኢና',
    step3: 'ምስ ተሰማማዕና ስራሕ ክንጅምር ኢና',
    step4: 'ኣብ ዝተሰማማዕናሉ ዕለት መጺኹም ክትወስድዎ ትኽእሉ ወይ ክነብጽሓልኩም ኢና።',
    form_title: 'ቅጥዒ ምእዛዝ',
    label_firstname: 'ስም',
    label_lastname: 'ዓሌት/መጸውዒ ስም',
    label_email: 'ኢመይል',
    label_phone: 'ቁጽሪ ቴሌፎን',
    label_type: 'ዓይነት ኬክ',
    label_date: 'ዝድለየሉ ዕለት',
    label_wishes: 'ድሌታትካ',
    ph_firstname: 'ሳባ',
    ph_lastname: 'ተስፋዝጊ',
    ...
    btn_submit: 'ጠለብ ስደዱ →',
    btn_sending: 'ይልኣኽ ኣሎ...',
    success_msg: '✓ የቐንየልና! ኣብ ውሽጢ 24 ሰዓታት ክንረኽበኩም ኢና።',
    error_msg: '✗ ጌጋ ተፈጢሩ። በጃኹም እንደገና ፈትኑ።',
    ...
    // ABOUT
    about_tag: 'ታሪኽና',
    about_title_pre: 'ብፍቕሪ ',
    about_title_em: 'ዝተዳለወ',
    ...
    // CURSUSSEN
    courses_tag: 'ካብቶም ዝበለጹ ተማሃር',
    courses_title_pre: 'ኮርሳትና ',
    ...
    faq_title_pre: 'መልሲ ናይ ',
    faq_title_em: 'ሕቶታትኩም',
    faq_q1: 'ቅድሚ ክንደይ እዋን ክንእዝዝ ኣለና?',
    faq_a1: 'ቢውሑዱ 2 ሰሙን ቅድሚ ዕለቱ። ብዙሕ ጠለባት ምስ ዝህልወኩም (ናይ ሃገር በዓላት፡ ናይ መርዓ ወቕቲ) ቅድሚ 4 ሰሙን ክትረኽቡና ነማኽር።',
    faq_q2: 'ዋጋ ክንደይ እዩ?',
    faq_a2: 'ኬክታት ካብ €45 ይጅምሩ። ልክዕ ዋጋ ብዓቐን፡ ዲዛይንን ምዕባዩን ይፈላለ። ጠለብካ ምስ ሰደድካ ብናጻ ናይ ዋጋ ሓሳብ ክንሰደልካ ኢና።',
    faq_q3: 'ዝተጠልበ ተበጻጽሑ ዲኹም ወላስ ባዕልና መጺና ኢና ክንወስዶ?',
    faq_a3: 'ክልቲኡ ይከኣል። ናብ ከባቢና ምብጻሕ ይካኣል። ቦታን ናይ ምብጻሕ ወጻኢታትን ከኣ ኣብ እዋን ጠለብኩም ክንዘራረበሎም ኢና።',
    faq_q5: 'ፍሉይ ዲዛይን ወይ ቀለም ምሕታት ይከኣልዶ?',
    faq_a5: 'እወ። ነፍሲ ወከፍ ኬክ ብናትካ ድሌት ይዳለው — ካብ ቀሊል ቀለም ክሳብ ምሉእ ፍሉይ ዲዛይን። ናይ ድሌትካ ስእልታት ኣብቲ ቅጥዒ ሓውሶም።',
    faq_q6: 'ብቕልጡፍ ከመይ ኢልና ክንረኽበኩም ንኽእል?',
