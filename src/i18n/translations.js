export const translations = {
  ...
  ti: {
    ...
    filter_special: 'ፍሉያት',
    btn_order_cake: 'እዚ ኬክ ዓይነት ይኣዝዙ',
    tag_wedding: 'መርዓ',
    tag_birthday: 'ልደት',
    tag_special: 'ፍሉይ',
    ...
    faq_q2: 'ዋጋ ክንደይ እዩ?',
    faq_a2: 'ኬካትና ካብ €45 ይጅምሩ። ልክዕ ዋጋ ድማ ብዓቐን፡ ዲዛይንን ምዕባዩን ይፈላለ። ጠለብኩም ምስ ሰደድኩም ብናጻ ናይ ዋጋ ሓሳብ ክንሰደልኩም ኢና።',
    ...
    faq_a5: 'እወ። ነፍሲ ወከፍ ኬክ ብናትኩም ድሌት ይዳለው — ካብ ቀሊል ቀለም ክሳብ ምሉእ ፍሉይ ዲዛይን። ድሌታትኩም ኣብ ቅጥዒ ሓዊስኩም ስደዱልና።',
